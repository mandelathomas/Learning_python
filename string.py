...
"""
What is a String
In Python, strings are fundamental data types used to represent sequences of characters, like text, words, phrases, etc. 
They are immutable, meaning they
...
b = 2
c = 12.4
print(f"Cisco model: {a}, {b} WAN slots, IOS {c}")
